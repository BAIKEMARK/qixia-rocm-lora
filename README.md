...
```text
/network-workspace/qixia-rocm-lora/outputs/qwen3_5_9b_lora
```

如果云端没有 `/network-workspace`，Notebook 会自动改用：

```text
/workspace/persist/qixia-rocm-lora/outputs/qwen3_5_9b_lora
```
...
```text
/network-workspace/qixia-rocm-lora/runtime_configs/qwen3_5_9b_lora.yaml
```

如果云端没有 `/network-workspace`，路径会落到：

```text
/workspace/persist/qixia-rocm-lora/runtime_configs/qwen3_5_9b_lora.yaml
```

然后执行：

```bash
python scripts/train_lora.py --config /workspace/persist/qixia-rocm-lora/runtime_configs/qwen3_5_9b_lora.yaml
```
